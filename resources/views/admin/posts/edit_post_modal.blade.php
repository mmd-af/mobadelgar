<div class="modal fade" id="editParentPost" tabindex="-1" aria-labelledby="editParentPostLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <h1 class="modal-title fs-5" id="editParentPostLabel">Edit Parent Post</h1>
            </div>
            <div class="modal-body">
                <div id="show_alert"></div>
                <form action="#" method="POST" onsubmit="event.preventDefault();updatePostForm()"
                      id="editPostForm">
                    @csrf
                    <div class="form-row">
