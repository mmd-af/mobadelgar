<div class="modal fade" id="createParentPost" tabindex="-1" aria-labelledby="createParentPostLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <h1 class="modal-title fs-5" id="createParentPostLabel">Create Parent Post</h1>
            </div>
